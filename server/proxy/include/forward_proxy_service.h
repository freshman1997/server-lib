#ifndef __SERVER_PROXY_FORWARD_PROXY_SERVICE_H__
#define __SERVER_PROXY_FORWARD_PROXY_SERVICE_H__

#include "server_runtime_host.h"
#include "core/app/include/service.h"
#include "core/core/include/net/auth_rate_limiter.h"
#include "protocol/socks5/include/socks5_config.h"
...
namespace yuan::server
{
    struct ProxyServiceConfig
    {
        ...
        int upstream_first_byte_timeout_ms = 15000;
    ...
    private:
        ...
        std::atomic_uint64_t total_bytes_up_{ 0 };
        std::atomic_uint64_t total_bytes_down_{ 0 };
