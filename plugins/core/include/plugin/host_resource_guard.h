...
namespace yuan::plugin
{
    ...
    {
        switch (type) {
        case PluginResourceType::event_subscription:
            return "event_subscription";
        case PluginResourceType::scheduler_task:
            return "scheduler_task";
        case PluginResourceType::service_registration:
            return "service_registration";
        case PluginResourceType::http_middleware:
        ...
        case PluginResourceType::async_task:
            return "async_task";
        case PluginResourceType::storage_session:
            return "storage_session";
        case PluginResourceType::custom:
            return "custom";
        default:
            return "unknown";
        }
    ...
    public:
        ...
        /// 获取指定插件的资源快照 (type -> count)
        virtual std::unordered_map<PluginResourceType, size_t> resource_snapshot(
