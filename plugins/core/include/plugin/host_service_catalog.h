...
namespace yuan::plugin
{
    ...
    enum class HostServiceScope {
        global,
        plugin_local,
    };

    enum class HostServiceLifetime {
        singleton,
        transient,
        scoped,
    };
    ...
    struct HostServiceDescriptor
    {
        ...
        HostServiceScope scope = HostServiceScope::global;
        HostServiceLifetime lifetime = HostServiceLifetime::singleton;
    };
