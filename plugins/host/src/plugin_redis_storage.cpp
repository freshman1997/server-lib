...
namespace yuan::app
{
    ...
    std::optional<std::string> PluginRedisStorage::get(const std::string & key) const
    {
        if (!is_available()) {
            return std::nullopt;
        }
    ...
    bool PluginRedisStorage::exists(const std::string & key) const
    {
        if (!is_available()) {
            return false;
        }
    ...
    std::optional<std::string> PluginRedisStorage::hget(const std::string & key, const std::string & field) const
    {
        if (!is_available()) {
            return std::nullopt;
        }
    ...
    std::unordered_map<std::string, std::string> PluginRedisStorage::hgetall(const std::string & key) const
    {
        if (!is_available()) {
            return {};
        }
