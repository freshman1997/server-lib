...
{
    ByteBuffer buf(16);
    buf.append(static_cast<uint8_t>(0x05));
    buf.append(static_cast<uint8_t>(0x01));
    buf.append(static_cast<uint8_t>(0x00));
...
bool test_greeting_parse_multiple_methods()
{
    ByteBuffer buf(16);
    buf.append(static_cast<uint8_t>(0x05));
    buf.append(static_cast<uint8_t>(0x03));
    buf.append(static_cast<uint8_t>(0x00));
    buf.append(static_cast<uint8_t>(0x01));
    buf.append(static_cast<uint8_t>(0x02));
...
{
    ByteBuffer buf(16);
    buf.append(static_cast<uint8_t>(0x04));
    buf.append(static_cast<uint8_t>(0x01));
    buf.append(static_cast<uint8_t>(0x00));
...
bool test_auth_request_parse()
{
    ByteBuffer buf(64);
    buf.append(static_cast<uint8_t>(0x04));
    buf.append(static_cast<uint8_t>('u'));
    buf.append(static_cast<uint8_t>('s'));
    buf.append(static_cast<uint8_t>('e'));
    buf.append(static_cast<uint8_t>('r'));
    buf.append(static_cast<uint8_t>(0x04));
    buf.append(static_cast<uint8_t>('p'));
    buf.append(static_cast<uint8_t>('a'));
    buf.append(static_cast<uint8_t>('s'));
    buf.append(static_cast<uint8_t>('s'));
...
bool test_auth_request_parse_incomplete()
{
    ByteBuffer buf(64);
    buf.append(static_cast<uint8_t>(0x05));
    buf.append(static_cast<uint8_t>('h'));
    buf.append(static_cast<uint8_t>('e'));
...
bool test_request_parse_connect_domain()
{
    ...
    buf.append(static_cast<uint8_t>(domain.size()));
...
bool test_build_method_select_reply_no_acceptable()
{
    ...
    TEST_ASSERT(span.size() == 2, "method select reply should be 2 bytes");
    TEST_ASSERT(span[0] == 0x05, "version should be 0x05");
    TEST_ASSERT(span[1] == 0xFF, "method should be no_acceptable (0xFF)");
...
bool test_udp_header_parse_ipv4()
{
    ...
    buf.append(static_cast<uint8_t>('H'));
    buf.append(static_cast<uint8_t>('E'));
    buf.append(static_cast<uint8_t>('L'));
    buf.append(static_cast<uint8_t>('L'));
    buf.append(static_cast<uint8_t>('O'));
...
bool test_socks5_server_auth_e2e()
{
    ...
    uint8_t auth[] = { 0x05, 0x05, 'a', 'd', 'm', 'i', 'n', 0x06, 's', 'e', 'c', 'r', 'e', 't' };
#ifndef _WIN32
    ...
    TEST_ASSERT(auth_response[0] == 0x05, "auth response version should be 0x05");
