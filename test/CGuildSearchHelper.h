...
#ifndef __CGUILDSEARCHHELPER_H__
#define __CGUILDSEARCHHELPER_H__
#include <cstdint>
#include <string>
...
struct TrieNode 
{
    ...
    std::unordered_map<uint64_t, int> gids; // 该节点对应的 gid 集合
...
private:
    ...
    std::string get_utf8_char(const std::string& str, int from) const;
...
#endif // __CGUILDSEARCHHELPER_H__
