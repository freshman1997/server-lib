#ifndef YUAN_GAME_SERVER_PLAYER_DB_PROXY_APP_PLAYER_DB_PROXY_SERVER_SERVICE_H
#define YUAN_GAME_SERVER_PLAYER_DB_PROXY_APP_PLAYER_DB_PROXY_SERVER_SERVICE_H
...
{
    class PlayerDbProxyServerService final : public yuan::app::Service, public yuan::app::RuntimeContextAwareService
    {
    public:
        explicit PlayerDbProxyServerService(ServiceServerConfig config);
    ...
    private:
        ...
        PlayerDbMsgContext player_db_context_;
        yuan::rpc::Server player_db_rpc_;
