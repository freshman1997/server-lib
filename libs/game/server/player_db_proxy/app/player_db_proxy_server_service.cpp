...
namespace yuan::game::server
{
    ...
    PlayerDbProxyServerService::PlayerDbProxyServerService(GameServiceId service_id,
        ...
        : service_id_(service_id),
          ...
          player_db_context_(ServiceAddress{service_id, 700, yuan::game_base::ServerRole::world, service_id.world, "player_db_proxy"}),
    ...
    bool PlayerDbProxyServerService::init()
    {
        ...
        player_db_context_.redis = redis_;
    ...
    bool PlayerDbProxyServerService::register_to_tunnel()
    {
