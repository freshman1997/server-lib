...
namespace yuan::game::server
{
    ...
    private:
        ...
        ClientFrameValidationOptions frame_validation_options_;
        ...
        std::vector<std::uint64_t> cleanup_queue_;
