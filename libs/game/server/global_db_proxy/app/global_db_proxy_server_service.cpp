...
namespace yuan::game::server
{
    ...
    GlobalDbProxyServerService::GlobalDbProxyServerService(GameServiceId service_id,
        ...
        : service_id_(service_id),
          ...
          global_db_context_(ServiceAddress{service_id, 700, yuan::game_base::ServerRole::world, service_id.world, "global_db_proxy"}),
          messaging_(std::move(tunnel_endpoints))
    {
        messaging_.set_heartbeat_interval_ms(tunnel_heartbeat_interval_ms_);
    }

    void GlobalDbProxyServerService::set_runtime_context(const yuan::app::RuntimeContext &context)
    {
        context_ = context;
    }

    bool GlobalDbProxyServerService::init()
    {
        ...
        option.name_ = "game-global-db-proxy";
        redis_ = std::make_shared<yuan::redis::RedisClient>(option);
        global_db_context_.redis = redis_;
    ...
    void GlobalDbProxyServerService::start()
    {
    ...
    void GlobalDbProxyServerService::stop()
    {
    ...
    bool GlobalDbProxyServerService::ok() const
    {
        return ok_;
    }

    bool GlobalDbProxyServerService::register_to_tunnel()
    {
