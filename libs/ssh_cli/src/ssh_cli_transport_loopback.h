#ifndef __LIBS_SSH_CLI_TRANSPORT_LOOPBACK_H__
#define __LIBS_SSH_CLI_TRANSPORT_LOOPBACK_H__

#include "ssh_cli_transport.h"

namespace yuan::libs::ssh_cli
{
    class SshCliTransportLoopback final : public SshCliTransport
    {
    public:
        ...
        const std::string &captured_stdin() const;
