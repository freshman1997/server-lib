...
namespace yuan::net
{
    ...
    public:
        ...
        {
            if (conn_) {
                conn_->set_connection_handler(&default_handler_);
            }
        }
        ...
        coroutine::Task<coroutine::ReadResult> read_async(uint32_t timeout_ms = 0)
        {
            ...
            co_return co_await coroutine::async_read(runtime_, conn_, timeout_ms);
        }
        ...
        coroutine::Task<coroutine::WriteResult> write_async(const ::yuan::buffer::ByteBuffer &buffer, uint32_t timeout_ms = 0)
        {
            ...
            co_return co_await coroutine::async_write(runtime_, conn_, buffer, timeout_ms);
        }
        ...
        coroutine::Task<coroutine::WriteResult> flush_async(uint32_t timeout_ms = 0)
        {
            ...
            co_return co_await coroutine::async_flush(runtime_, conn_, timeout_ms);
        }
        ...
        coroutine::Task<coroutine::IoStatus> close_async()
        {
            ...
            closed_ = true;
            co_return co_await coroutine::async_close(runtime_, conn_);
        }
        ...
        coroutine::Task<coroutine::SslHandshakeResult> ssl_handshake_async(uint32_t timeout_ms = 0)
        {
            ...
            co_return co_await coroutine::async_ssl_handshake(runtime_, conn_, timeout_ms);
        }
