...
namespace yuan::net
{
    ...
    public:
        ...
        virtual buffer::Buffer * get_input_buff(bool take = false) = 0;

        virtual buffer::Buffer * get_output_buff(bool take = false) = 0;
        ...
        virtual void process_input_data(std::function<bool (buffer::Buffer *buff)>, bool clear = true) = 0;

        virtual buffer::LinkedBuffer * get_input_linked_buffer() = 0;

        virtual buffer::LinkedBuffer * get_output_linked_buffer() = 0;
