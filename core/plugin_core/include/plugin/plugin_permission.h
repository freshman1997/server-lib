...
struct PluginPermissionNames
{
    ...
    {
        switch (p) {
        case PluginPermission::use_event_bus:       return "use_event_bus";
        case PluginPermission::use_logger:          return "use_logger";
        case PluginPermission::use_scheduler:       return "use_scheduler";
        case PluginPermission::use_service_catalog: return "use_service_catalog";
        case PluginPermission::use_service_registry:return "use_service_registry";
        case PluginPermission::use_http_intercept:  return "use_http_intercept";
        case PluginPermission::use_storage:         return "use_storage";
        case PluginPermission::all:                 return "all";
