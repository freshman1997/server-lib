...
#pragma pack(push, 1)
    struct UtpHeader
    {
        ...
        UtpType get_type() const
        {
            return static_cast<UtpType>(type & 0x0F);
        }
...
#pragma pack(pop)
    ...
    class UtpConnection : public net::ConnectionHandler
    {
    ...
    public:
        ...
        uint32_t get_send_conn_id() const
        {
            return send_conn_id_;
        }

        void set_data_handler(DataHandler h)
        {
            data_handler_ = std::move(h);
        }
        void set_state_change_handler(StateChangeHandler h)
        {
            state_change_handler_ = std::move(h);
        }
    ...
    public:
        ...
        void set_new_peer_callback(NewUtpPeerCallback cb)
        {
