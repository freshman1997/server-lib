...
namespace yuan::net::http
{
    ...
    public:
        ...
        void set_exceed_save_file(bool flag) { exceed_save_file_ = flag; }
        void set_max_chunk_size(std::size_t size) { max_chunk_size_ = size; }
        void set_disk_spill_size(std::size_t size) { disk_spill_size_ = size; }
